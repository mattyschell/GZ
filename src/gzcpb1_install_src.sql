...
/
@"/mtdata004/mapping/gz/dev/devbnch/schel010/generalization/src/GZ_FEATURE_FACE.tps";
/
show errors;
...
/
@"/mtdata004/mapping/gz/dev/devbnch/schel010/generalization/src/GZ_FEATURE_FACE.tpb";
/
show errors;
GRANT EXECUTE ON GZ_FEATURE_FACE TO "PUBLIC";
...
begin 
  DBMS_OUTPUT.PUT_LINE('Installing /mtdata004/mapping/gz/dev/devbnch/schel010/generalization/src/GZ_BUSINESS_UTILS.pks...');
end;
/
@"/mtdata004/mapping/gz/dev/devbnch/schel010/generalization/src/GZ_BUSINESS_UTILS.pks";
/
show errors;
GRANT EXECUTE ON GZ_BUSINESS_UTILS TO "PUBLIC";
...
begin 
  DBMS_OUTPUT.PUT_LINE('Installing /mtdata004/mapping/gz/dev/devbnch/schel010/generalization/src/GZ_GEOM_UTILS.pks...');
end;
/
@"/mtdata004/mapping/gz/dev/devbnch/schel010/generalization/src/GZ_GEOM_UTILS.pks";
/
show errors;
GRANT EXECUTE ON GZ_GEOM_UTILS TO "PUBLIC";

timing show;

begin 
  DBMS_OUTPUT.PUT_LINE('Installing /mtdata004/mapping/gz/dev/devbnch/schel010/generalization/src/GZ_INTERACTIVE_UTILS.pks...');
end;
/
@"/mtdata004/mapping/gz/dev/devbnch/schel010/generalization/src/GZ_INTERACTIVE_UTILS.pks";
/
show errors;
GRANT EXECUTE ON GZ_INTERACTIVE_UTILS TO "PUBLIC";
...
begin 
  DBMS_OUTPUT.PUT_LINE('Installing /mtdata004/mapping/gz/dev/devbnch/schel010/generalization/src/GZ_QA_BASICS.pks...');
end;
/
@"/mtdata004/mapping/gz/dev/devbnch/schel010/generalization/src/GZ_QA_BASICS.pks";
/
show errors;
GRANT EXECUTE ON GZ_QA_BASICS TO "PUBLIC";
...
begin 
  DBMS_OUTPUT.PUT_LINE('Installing /mtdata004/mapping/gz/dev/devbnch/schel010/generalization/src/GZ_BUSINESS_UTILS.pkb...');
end;
/
@"/mtdata004/mapping/gz/dev/devbnch/schel010/generalization/src/GZ_BUSINESS_UTILS.pkb";
/
show errors;
GRANT EXECUTE ON GZ_BUSINESS_UTILS TO "PUBLIC";
...
begin 
  DBMS_OUTPUT.PUT_LINE('Installing /mtdata004/mapping/gz/dev/devbnch/schel010/generalization/src/GZ_GEOM_UTILS.pkb...');
end;
/
@"/mtdata004/mapping/gz/dev/devbnch/schel010/generalization/src/GZ_GEOM_UTILS.pkb";
/
show errors;
GRANT EXECUTE ON GZ_GEOM_UTILS TO "PUBLIC";
...
begin 
  DBMS_OUTPUT.PUT_LINE('Installing /mtdata004/mapping/gz/dev/devbnch/schel010/generalization/src/GZ_INTERACTIVE_UTILS.pkb...');
end;
/
@"/mtdata004/mapping/gz/dev/devbnch/schel010/generalization/src/GZ_INTERACTIVE_UTILS.pkb";
/
show errors;
GRANT EXECUTE ON GZ_INTERACTIVE_UTILS TO "PUBLIC";
...
begin 
  DBMS_OUTPUT.PUT_LINE('Installing /mtdata004/mapping/gz/dev/devbnch/schel010/generalization/src/GZ_QA_BASICS.pkb...');
end;
/
@"/mtdata004/mapping/gz/dev/devbnch/schel010/generalization/src/GZ_QA_BASICS.pkb";
/
show errors;
GRANT EXECUTE ON GZ_QA_BASICS TO "PUBLIC";
